...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:mamaco\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=559282715402:+55 928271-5402\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '/','*','.'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD mamaco BOT*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de mamaco. Registre-se para fazer amizade com o bot mamaco por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar mamaco|14\n\n──「 mamaco BOT 」──`,
			...
			const ownerNumber = ["559282715402@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"559282715402@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["559282715402@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["559282715402@s.whatsapp.net"]//ubah nomor lo
			const premium = ["559282715402@s.whatsapp.net","559784130980@s.whatsapp.net","5511968610803@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","5514991711674@s.whatsapp.net"]
			...
			const isBotGroupAdmins = groupAdmins.includes(botNumber) || falsel
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
	...
	if (messagesC.includes("bosta")){
		...
		if (messagesC.includes("bot")){
			...
			client.updatePresence(from, Presence.composing)
			data = fs.readFileSync('./src/mamacojokes.js');
...
//@mamacoYT					
    ...
    break
            ...
            case 'rapL':
				...
				case 'daftar':
					client.updatePresence(from, Presence.composing)
					if (args.length < 1) return reply(`Parameter Salah\nCommand : ${prefix}daftar nama|umur\nContoh : ${prefix}daftar mamaco|14`)
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOO mamaco BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @mamaco domina vida
          ...
          reply('Espere..')
			    ...
			    case 'dono':
                    ...
                    client.sendMessage(from, 'Meu dono é esse gasoso aí tal de "mamaco"🙄, chama ele aí ele diz que é "Shitpost"',MessageType.text, { quoted: mek} )
                    break
                case 'fitnah':	
				case 'fake':          
                    if (!isGroup) return reply(mess.only.group)
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT mamaco ✨* 」\n*│+ wa.me/559282715402*╰──────*「 *mamaco* 」*────*\n\n*_SE QUER SER ADMIN DO BOT mamaco_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do mamaco:*\n\n https://youtube.com/channel/UCZEtf9AlsC2zsJQwrfW-44w'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* mamaco\n*YOUTUBE:* https://youtube.com/channel/UCZEtf9AlsC2zsJQwrfW-44w\n*WPP:* wa.me/+559282715402\n*\n\nEspero que tenham gostado do bot️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
